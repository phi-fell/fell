package OLDcom.monolc.fell.program;
...
import OLDcom.monolc.fell.graphics.Text;
import OLDcom.monolc.fell.net.ClientIO;
...
import OLDcom.monolc.fell.window.Event;
import OLDcom.monolc.fell.window.Window;
import OLDcom.monolc.fell.world.Floor;
import OLDcom.monolc.fell.world.Player;
...
public class Client {
	...
	public void initialize() {
		...
		// plr = new Player(resources.getSprite("player"),
		// currentFloor.getOpenLocation());
		plr = new Player(new Sprite("player", Text.getTexture("Hello"), 200, 50), currentFloor.getOpenLocation());
		zoom = 0;
